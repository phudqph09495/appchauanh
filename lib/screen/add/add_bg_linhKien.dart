            ...
            children: [
              ...
              ListView.builder(
                itemBuilder: (context, index) {
                  ...
                  gia.text = Const.ConvertPrice.format(int.parse(
                      danhsachLK[index].price!.replaceAll('.', '') ?? '0'));
                ...
                child: Button1(
                  ontap: () {
                    ...
                    for (var item in danhsachLK) {
                      listM.add(Mattrs(
                          id: item.modelLinkKien!.id,
                          amount: item.soLuong,
                          salePrice: item.price!.replaceAll(".", "")));
                    }
