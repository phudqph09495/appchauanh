...
class Bloc_DetailCongNo extends Bloc<EventBloc, StateBloc> {
  Bloc_DetailCongNo() : super(StateBloc());
    ...
    if (event is GetData) {
      ...
      try {
        ...
        var res = await Api.getAsync(
            endPoint: ApiPath.detailCongNo+event.param,  isToken: true);

        if (res['status'] == true) {
          Model_DetailCongNo model = Model_DetailCongNo.fromJson(res['data']);
